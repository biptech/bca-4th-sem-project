...
<head>
    ...
    <title> Online Education & Learning System | Category Page</title>
...
?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="learn-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="card-title text-decoration-none text-dark">
                            <h2 class="card-title text-dark"><?php echo htmlentities($row['posttitle']);?></h2>
                        </a>

                        <a href="learn-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Read More &rarr;</a>
                    </div>
