                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <!-- <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-newspaper"></i> <span> Cart </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-cart.php">Add Cart</a></li>
                                    <li><a href="manage-carts.php">Manage Cart</a></li>
                                    <li><a href="trash-carts.php">Trash Cart</a></li>
                                </ul>
                            </li> -->
                            ...
                            <li>
                                <a href="https://www.youtube.com/@BipTechOfficial" class="waves-effect"><i class="ti ti-info-alt"></i> <span>Watch Video</span></a>
